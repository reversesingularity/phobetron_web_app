          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <select id="theme-select" className="mt-1 w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2 text-sm text-zinc-50" suppressHydrationWarning>
              ...
              <div>
                ...
                <select id="timezone-select" className="mt-1 w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2 text-sm text-zinc-50" suppressHydrationWarning>
                  <option>UTC</option>
          ...
          <div className="rounded-lg border border-zinc-800 bg-zinc-900/50 p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select id="refresh-interval" className="mt-1 w-full rounded-lg border border-zinc-800 bg-zinc-950 px-3 py-2 text-sm text-zinc-50" suppressHydrationWarning>
