...
export default function CelestialCanvas({
  ...
  useEffect(() => {
    ...
    const loadOrbitalData = async () => {
      try {
        ...
        // TEMPORARY: Use fallback data directly (bypassing API to use corrected hard-coded data)
        const fallbackData = getFallbackOrbitalData();
  ...
  return (
    <div ref={containerRef} className="w-full h-full bg-black relative">
      ...
      <div className="absolute top-4 right-90 z-50 pointer-events-auto">
...
function addPlanets(
  ...
  allObjects.forEach((objectData) => {
    ...
    const shouldShowLabel = objectData.type === 'planet' || 
                           ['Ceres', 'Vesta', 'Pallas', 'Hygiea', 'Eunomia', 'Juno', "Halley's Comet", 'Hale-Bopp', 'Swift-Tuttle', 'Encke', 'Apophis', 'Ryugu', "1I/'Oumuamua", '2I/Borisov', '3I/ATLAS', 'C/2025 A6 (Lemmon)', 'C/2025 R2 (SWAN)', '12P/Pons-Brooks'].includes(objectData.name);
...
function updatePlanetPositions(
  ...
  orbitalData.forEach((objectData) => {
    ...
    const isVeryLongPeriod = orbitalPeriodYears > 1000 || objectData.mld < 10;
