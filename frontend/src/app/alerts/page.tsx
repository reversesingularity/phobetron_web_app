      ...
      <div className="p-6">
        ...
        <div className="rounded-lg border border-zinc-800 bg-zinc-900/50">
          <div className="border-b border-zinc-800 p-4">
            ...
            <p className="text-sm text-zinc-400">Auto-refreshing every 30 seconds</p>
          </div>
            ...
            {loading && !alerts.length && (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-sm text-zinc-400">Loading alerts...</p>
                </div>
              </div>
            )}
            ...
            {!loading && !error && alerts.length === 0 && (
              <div className="flex items-center justify-center py-12">
                <div className="text-center">
                  ...
                  <p className="mt-4 text-zinc-400">No active alerts</p>
                  <p className="mt-1 text-sm text-zinc-500">All systems operational</p>
                </div>
              </div>
            )}
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-zinc-400">{alert.alert_type}</p>
                          {alert.description && (
                            <p className="mt-2 text-sm text-zinc-500">{alert.description}</p>
                          )}
