/**
 * Alerts Page - Enhanced with ML/AI Monitoring
 * 
 * Display and manage real-time alerts with AI-powered event detection
 */
...
import MLEventMonitor from '@/components/alerts/MLEventMonitor';
import { 
  BellAlertIcon, 
...
export default function AlertsPage() {
  ...
  const [viewMode, setViewMode] = useState<'alerts' | 'ml'>('ml'); // Default to ML view
    ...
    <MainLayout title="Alerts" subtitle="Real-time Monitoring & Notifications">
      <div className="relative min-h-screen bg-zinc-950 p-6 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          {/* ML Event Monitor View */}
          {viewMode === 'ml' && <MLEventMonitor />}

          {/* Traditional Alerts View */}
          {viewMode === 'alerts' && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
