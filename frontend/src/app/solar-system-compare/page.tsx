 ...
 * - Our Modern React Three Fiber implementation
 * - TheSkyLive.com original implementation
 */
...
export default function SolarSystemComparePage() {
  const [activeView, setActiveView] = useState<'split' | 'modern' | 'skylive'>('split');

  return (
    <MainLayout
      title="Solar System Comparison"
      subtitle="Modern R3F vs TheSkyLive.com Implementation"
    >
      <div className="h-[calc(100vh-4rem)] bg-black flex flex-col">
        ...
        <div className="flex-1 flex">
          ...
          {/* TheSkyLive Implementation */}
          {(activeView === 'skylive' || activeView === 'split') && (
        ...
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 z-50 bg-zinc-900/95 backdrop-blur-md p-3 rounded-lg border border-zinc-700">
          <div className="text-center">
            <p className="text-xs text-zinc-400 mb-1">Both implementations use TheSkyLive color scheme</p>
